...
- Auto-warm: in `app/Controllers/Admin/AlbumsController.php:50` viene chiamato `CacheWarmService->warmAlbum()`, metodo inesistente → eccezione soppressa → niente warm automatico degli album dopo salvataggi.
